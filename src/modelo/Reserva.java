...
/**
 * Modelo reserva con métodos insert, update y darDeBaja. También valida las
 * fechas.
 * 
 * @author Tomas
 *
...
public class Reserva {
	...
	/**
	 * Inserta la reserva con los atributos instanciados en la base de datos
	 * 
	...
	/**
	 * Actualiza usando los atributos instanciados la reserva con la id introducida
	 * 
	 * @param id
	 * @return true si finaliza
	 */
	public boolean update(int id) {
		try {
			...
			if (this.fecha_salida != null)
				rs.updateString("fecha_salida", this.fecha_salida);
			if (this.numero_adultos != 0)
				rs.updateInt("numero_adultos", this.numero_adultos);
			if (this.numero_ninyos != 0)
				rs.updateInt("numero_ninyos", this.numero_ninyos);
	...
	/**
	 * Convierte el string de fecha al formato fecha para compararla con la fecha
	 * actual
	 * 
	 * @param fecha
	...
	/**
	 * Método para validar las fechas instanciadas de entrada y de salida
	 * 
	 * @throws ParseException
	 */
	public void compararFechas() throws ParseException {
		...
		if (result > 0)
			throw new IllegalArgumentException("La fecha de entrada no puede ser posterior a la salida");
	}
	...
	/**
	 * Valida la fecha de entrada introducida
	 * 
	 * @param fecha_entrada
	 * @throws ParseException
	 */
	public void setFecha_entrada(String fecha_entrada) throws ParseException {
		...
		if (fecha_entrada.equals(""))
			throw new IllegalArgumentException("El campo fecha de entrada no puede estar vacío");
		if (fechaAntigua(fecha_entrada))
	...
	/**
	 * Valida la fecha de salida introducida
	 * 
	 * @param fecha_salida
	 * @throws ParseException
	 */
	public void setFecha_salida(String fecha_salida) throws ParseException {
		...
		if (fecha_salida.equals(""))
			throw new IllegalArgumentException("El campo fecha de salida no puede estar vacío");
		if (fechaAntigua(fecha_salida))
	...
	/**
	 * Valida el id de usuario y comprueba que existe
	 * 
	 * @param user_id
	 */
	...
	/**
	 * Valida el número de adultos
	 * 
	 * @param cad
	 */
	public void setNumero_adultos(String cad) {
		if (cad == null)
			throw new NullPointerException("null num adultos");
		if (cad.equals(""))
			cad = "1";
		try {
	...
	/**
	 * Valida el número de niños
	 * 
	 * @param cad
	 */
	public void setNumero_ninyos(String cad) {
		if (cad == null)
			throw new NullPointerException("null num niños");
		if (cad.equals(""))
			cad = "10";
		try {
