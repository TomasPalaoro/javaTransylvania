...
/**
 * Vista principal que incluye los CRUDS de usuarios, reservas y habitaciones
 * 
 * @author Tomas
 *
 */
public class VentanaPrincipal {
	...
	/**
	 * Controlador de eventos genéricos
	 */
	...
	public VentanaPrincipal() {
		 ...
		 * placeholder.changeAlpha(0.75f); placeholder.changeStyle(Font.ITALIC);
		 */
	}

	/**
	 * Genera un selector de fecha
	 * 
	 * @return
	 */
	...
	/**
	 * Genera una caja de texto con autocompleción de todos los posibles usuarios
	 * del controller de las tablas
	 * 
	 * @return
	 */
	...
	/**
	 * Genera un NumberFormatter que permite solo números enteros
	 * 
	 * @return
	 */
	...
	/**
	 * Genera la cabecera de la tabla de usuarios con los botones de paginación
	 * 
	 * @return
	 */
	private JPanel headerUsers() {
		JPanel panelHeaderUsers = new JPanel();
		btnMostrarCrearUser = new JButton(
				CargarIcono.crearIcono(getClass().getResource("/iconos/addUserWhite.png"), "Añadir usuario", 34));
		...
		btnEditarUser = new JButton(
				CargarIcono.crearIcono(getClass().getResource("/iconos/editar.png"), "Editar usuario", 34));
		...
		btnEliminarUser = new JButton(
				CargarIcono.crearIcono(getClass().getResource("/iconos/papelera.png"), "Eliminar usuario", 34));
		...
		btnBuscarUser = new JButton(
				CargarIcono.crearIcono(getClass().getResource("/iconos/buscar.png"), "Buscar usuario", 34));
	...
	/**
	 * Genera la cabecera de la tabla de reservas con los botones de paginación
	 * 
	 * @return
	 */
	private JPanel headerReservas() {
		...
		btnEditarReserva = new JButton(
				CargarIcono.crearIcono(getClass().getResource("/iconos/editar.png"), "Editar reserva", 34));
		...
		btnEliminarReserva = new JButton(
				CargarIcono.crearIcono(getClass().getResource("/iconos/papelera.png"), "Eliminar reserva", 34));
		...
		btnBuscarReserva = new JButton(
				CargarIcono.crearIcono(getClass().getResource("/iconos/buscar.png"), "Buscar reserva", 34));
	...
	/**
	 * Genera la cabecera de la tabla de habitaciones con los botones de paginación
	 * 
	 * @return
	 */
	private JPanel headerHabitaciones() {
		...
		btnMostrarCrearHabitacion = new JButton(
				CargarIcono.crearIcono(getClass().getResource("/iconos/habitacion.png"), "Añadir usuario", 34));
		...
		btnEditarHabitacion = new JButton(
				CargarIcono.crearIcono(getClass().getResource("/iconos/editar.png"), "Editar reserva", 34));
		...
		btnEliminarHabitacion = new JButton(
				CargarIcono.crearIcono(getClass().getResource("/iconos/papelera.png"), "Eliminar reserva", 34));
	...
	/**
	 * Genera el lateral de la tabla usuarios con el panel de añadir usuario
	 * 
	 * @return
	 */
	...
	/**
	 * Genera el lateral de la tabla habitaciones con el panel de añadir habitación
	 * 
	 * @return
	 */
	private JPanel generarLateralHabitaciones() {
		...
		iconoAddHabitacion.setIcon(
				CargarIcono.crearIcono(getClass().getResource("/iconos/habitacion.png"), "Añadir habitacion", 34));
	...
	private void initialize() {
		...
		gl_groupCrearReserva.setHorizontalGroup(gl_groupCrearReserva.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_groupCrearReserva.createSequentialGroup().addGap(36)
						.addComponent(lblBienvenido, GroupLayout.DEFAULT_SIZE, 175, Short.MAX_VALUE).addGap(675))
				.addGroup(gl_groupCrearReserva.createSequentialGroup()
						.addGroup(gl_groupCrearReserva.createParallelGroup(Alignment.TRAILING)
								.addGroup(gl_groupCrearReserva.createSequentialGroup().addContainerGap().addComponent(
										btnCrearReserva, GroupLayout.PREFERRED_SIZE, 254, GroupLayout.PREFERRED_SIZE))
								.addGroup(
										gl_groupCrearReserva
												.createParallelGroup(Alignment.TRAILING).addGroup(gl_groupCrearReserva
														.createSequentialGroup().addContainerGap()
														.addComponent(lblUsuario, GroupLayout.PREFERRED_SIZE, 148,
																GroupLayout.PREFERRED_SIZE)
														.addGap(4)
														.addComponent(tfUsuario, GroupLayout.PREFERRED_SIZE, 368,
																GroupLayout.PREFERRED_SIZE))
												.addGroup(Alignment.LEADING,
														gl_groupCrearReserva.createSequentialGroup().addGap(108)
																.addComponent(lblTitulo, GroupLayout.DEFAULT_SIZE, 576,
																		Short.MAX_VALUE))
												.addGroup(Alignment.LEADING, gl_groupCrearReserva
														.createSequentialGroup().addContainerGap(164, Short.MAX_VALUE)
														.addGroup(gl_groupCrearReserva
																.createParallelGroup(Alignment.TRAILING)
																.addGroup(gl_groupCrearReserva.createSequentialGroup()
																		.addComponent(lblHabitacion,
																				GroupLayout.PREFERRED_SIZE, 148,
																				GroupLayout.PREFERRED_SIZE)
																		.addGap(4).addComponent(comboBoxHabitaciones,
																...
																.addGroup(gl_groupCrearReserva.createSequentialGroup()
																		...
																		.addComponent(formattedNumAdultos,
																				GroupLayout.PREFERRED_SIZE, 50,
																				GroupLayout.PREFERRED_SIZE)
																		.addGap(28)
																		.addComponent(lblNinyos,
																				GroupLayout.PREFERRED_SIZE, 148,
																				GroupLayout.PREFERRED_SIZE)
																		.addPreferredGap(ComponentPlacement.RELATED)
																		.addComponent(
																...
																.addGroup(gl_groupCrearReserva.createSequentialGroup()
																		.addComponent(lblSalida,
																				GroupLayout.PREFERRED_SIZE, 148,
																				GroupLayout.PREFERRED_SIZE)
																		.addGap(4).addComponent(datePickerSalida,
																				GroupLayout.PREFERRED_SIZE, 368,
																				GroupLayout.PREFERRED_SIZE))
																.addGroup(gl_groupCrearReserva.createSequentialGroup()
																		.addComponent(lblEntrada,
																				...
																				GroupLayout.PREFERRED_SIZE)
																		.addPreferredGap(ComponentPlacement.RELATED)
																		.addComponent(datePickerEntrada,
																				GroupLayout.PREFERRED_SIZE, 368,
																				GroupLayout.PREFERRED_SIZE))))))
						.addGap(202)));
		gl_groupCrearReserva.setVerticalGroup(gl_groupCrearReserva.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_groupCrearReserva.createSequentialGroup().addGap(18).addComponent(lblBienvenido)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblTitulo).addGap(30)
						.addGroup(gl_groupCrearReserva.createParallelGroup(Alignment.BASELINE)
								.addComponent(datePickerEntrada, GroupLayout.PREFERRED_SIZE, 30,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(lblEntrada))
						.addGap(18)
						.addGroup(gl_groupCrearReserva.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_groupCrearReserva.createSequentialGroup().addGap(3).addComponent(lblSalida,
										GroupLayout.PREFERRED_SIZE, 19, GroupLayout.PREFERRED_SIZE))
								.addComponent(datePickerSalida, GroupLayout.PREFERRED_SIZE, 30,
										GroupLayout.PREFERRED_SIZE))
						.addGap(18)
						.addGroup(gl_groupCrearReserva.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_groupCrearReserva.createSequentialGroup().addGap(24).addComponent(
										lblHabitacion, GroupLayout.PREFERRED_SIZE, 19, GroupLayout.PREFERRED_SIZE))
								.addGroup(gl_groupCrearReserva.createSequentialGroup().addGap(21).addComponent(
										comboBoxHabitaciones, GroupLayout.PREFERRED_SIZE, 30,
										GroupLayout.PREFERRED_SIZE)))
						.addGap(39)
						.addGroup(gl_groupCrearReserva.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_groupCrearReserva.createSequentialGroup().addGap(3)
										.addGroup(gl_groupCrearReserva.createParallelGroup(Alignment.BASELINE)
												.addComponent(lblAdultos, GroupLayout.PREFERRED_SIZE, 19,
														GroupLayout.PREFERRED_SIZE)
												.addComponent(formattedNumAdultos, GroupLayout.PREFERRED_SIZE, 24,
														GroupLayout.PREFERRED_SIZE)))
								.addGroup(gl_groupCrearReserva.createParallelGroup(Alignment.BASELINE)
										.addComponent(lblNinyos, GroupLayout.PREFERRED_SIZE, 19,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(formattedNumNinyos, GroupLayout.PREFERRED_SIZE, 24,
												GroupLayout.PREFERRED_SIZE)))
						.addGap(30)
						.addGroup(gl_groupCrearReserva.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_groupCrearReserva.createSequentialGroup().addGap(3).addComponent(
										lblUsuario, GroupLayout.PREFERRED_SIZE, 19, GroupLayout.PREFERRED_SIZE))
